...
- **Companion plugin packaging.** Ship the target-site endpoint as a reusable Payload plugin. A copy-paste endpoint can exist only as a debugging aid, not as a supported write-back path.
